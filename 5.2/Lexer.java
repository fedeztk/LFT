                ...
                if (peek == '*') { // commenti /**/
                    ...
                    while (!end) {
                        ...
                        if ((int) peek == 65535) {
                            ...
                            readch(br);
                            if (peek == '/') { // chiusura asterisco
                                end = true;
                                readch(br);
                                break;
                            } else if (peek == '*') { // caso di piu' '*' di seguito
                                while (peek == '*') {
                                    readch(br);
                                    if (peek == '/') {
                                        end = true;
                    ...
                    return lexical_scan(br); // chiamata ricorsiva al prossimo carattere -return-
                } else if (peek == '/') {
