...
public class Lexer0 {
    ...
    public Token lexical_scan(BufferedReader br) {
        ...
        switch (peek) {
            ...
            default:
                if (Character.isLetter(peek) && Character.isLowerCase(peek)) { // restituisce<257(identificatore),
                                                                               // n@stessa>
                    String parola;
                    for (parola = ""; Character.isLetter(peek) || Character.isDigit(peek); readch(br)) {
                        parola += peek;
                    }
